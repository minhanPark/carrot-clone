        ...
        {Array(6)
          ...
          .map((_, i) => (
            <div key={i} className="flex flex-col items-start cursor-pointer">
              <span className="flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-300 text-gray-900">
                동네질문
              </span>
              ...
              <div className="flex space-x-5 mt-3 text-gray-700 px-2.5 py-2 border-t border-b-2 w-full">
