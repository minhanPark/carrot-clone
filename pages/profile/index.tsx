      ...
      <div className="py-16">
        <div className="flex items-center space-x-3">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-sm text-gray-400">Edit profile &rarr;</span>
          </div>
        </div>
        <div className="mt-10 flex justify-around">
          <div className="flex flex-col items-center cursor-pointer group">
            <div className="w-14 h-14 text-white bg-orange-500 flex justify-center items-center rounded-full group-hover:bg-orange-600">
              <svg
                className="w-6 h-6"
                fill="none"
                stroke="currentColor"
